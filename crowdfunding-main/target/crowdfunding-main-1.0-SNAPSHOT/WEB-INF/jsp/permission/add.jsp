            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="addForm">
                        ...
                        <div class="form-group">
                            <label for="furl">url地址</label>
                            <input type="email" class="form-control" id="furl" placeholder="请输入url地址">
                            <p class="help-block label label-warning">请输入合法的url</p>
                        </div>
...
<script type="text/javascript">
    ...
    $("#resetBtn").click(function () {
        // $("#addForm")[0]： 获取jQuery对象中的dom对象，再调用其reset()函数进行重置
        // 可以将jQuery对象看成数组，其第一个元素即为dom对象
        // jQuery对象没有reset()函数
        $("#addForm")[0].reset();
    });
</script>
