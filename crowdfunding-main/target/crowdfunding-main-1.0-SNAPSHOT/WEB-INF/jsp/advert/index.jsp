	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<div>
					<a class="navbar-brand" style="font-size: 32px;" href="#">众筹平台 - 广告维护</a>
				</div>
			</div>
	...
	<script type="text/javascript">
            ...
            function queryPage( pageIndex ){
            	...
            	$.ajax({
            		...
            		url : "${APP_PATH}/advert/queryPage.do",
            		type : "post",
            		data : dataObj,
            		beforeSend : function(){
            		...
            		success : function(result){
            			...
            			if(result.success){
            				...
            				$.each(list,function(i,n){
								...
								content+="	<td>";
								content+="		<button type='button' onclick='window.location.href=\"${APP_PATH}/advert/update.htm?pageno="+pageObj.pageno+"&id="+n.id+"\"' class='btn btn-primary btn-xs'>";
