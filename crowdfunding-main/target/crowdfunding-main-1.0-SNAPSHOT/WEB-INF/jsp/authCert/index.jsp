...
<script type="text/javascript">
    ...
    function pageQuery(pageIndex) {
        ...
        $.ajax({
            url : "${APP_PATH}/authCert/queryPage.do",
            type : "POST",
            data : obj,
            beforeSend : function() {
            ...
            success : function( result ) {
                ...
                if ( result.success ) {
                    ...
                    $.each(taskList, function(i, task){
                        ...
                        content += '  <td>';
                        content += '      <button type="button" value="审核" onclick="window.location.href=\'${APP_PATH}/authCert/showCert.htm?taskId='+task.taskId+'&memberId='+task.member.id+'\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
                        content += '  </td>';
                        content += '</tr>';
                    });
                    $("tbody").html(content);
