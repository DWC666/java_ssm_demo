...
<div class="container theme-showcase" role="main">
    ...
    <form role="form" style="margin-top:20px;">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="email" value="${member.email}" placeholder="请输入用于接收验证码的邮箱地址">
        </div>
    ...
    $("#nextBtn").click(function() {
        $.ajax({
            ...
            success : function(result) {
                if ( result.success ) {
                    // layer.alert("已发送验证码，请查看邮箱");
                    window.location.href = "${APP_PATH}/member/apply.htm";
                } else {
                    layer.msg("发送验证码失败", {time:2000, icon:5, shift:6});
                }
            }
        });
    });
